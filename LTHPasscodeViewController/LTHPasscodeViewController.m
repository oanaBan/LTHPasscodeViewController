...
- (void)viewDidLoad {
    ...
    [_animatingView addSubview:self.snapShotImageView];
    [self.snapShotImageView setTranslatesAutoresizingMaskIntoConstraints:NO];
    
    self.logoImageView = [[UIImageView alloc] init];
    [_animatingView addSubview:self.logoImageView];
...
- (void)updateViewConstraints {
    ...
    CGFloat yOffsetFromCenter = -self.view.frame.size.height * 0.15 + _verticalOffset; // Oana change
